...
const CHAT={
	...
	onlineCount:0,
	onlineUsers:null,
	msgArr:[],		//{onlineUsers:onlineUsers, onlineCount:onlineCount, user:{userid:this.userid, username:this.username,color:this.color,weichat:this.weichat},login:true}
	//让浏览器滚动条保持在最低部
	...
	init:function(){
		...
		*/
		...
		this.socket = io.connect('http://192.168.0.126:3000');
